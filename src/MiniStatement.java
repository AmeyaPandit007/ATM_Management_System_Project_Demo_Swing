...
public class MiniStatement extends JFrame
{
	...
	public MiniStatement(String pin) 
	{
        ...
        lblNewLabel.setIcon(new ImageIcon(MiniStatement.class.getResource("/icons/bank-statement-icon4.jpg")));
        lblNewLabel.setBounds(58, 11, 110, 119);
